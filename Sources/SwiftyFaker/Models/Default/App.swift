...
extension SwiftyFaker {
    enum App {
        ...
        static let version = versionData.random().numberize()
        
        static let author = authorData.random()
        ...
        // own range choosing
        static func semanticVersion(major: Int = Int.random(in: 1...9), minor: Int = Int.random(in: 0...9), patch: Int = Int.random(in: 1...9)) {
